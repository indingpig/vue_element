<template>
  <div class="login-wrap">
    <div
      class="login-wrap-background"
      :style="{'background-image':'url('+ imgUrl +')', opacity: opacityNum}"
    ></div>
    <div class="login">
      <div class="login-top">
    ...
    <div class="sign-up">
      <el-dialog
        ...
        class
      >
        <el-form :model="siginUpForm" :rules="signUpRules" ref="siginUpFormRules">
          <el-form-item prop="userEmail">
            <el-input placeholder="请输入邮箱" v-model="siginUpForm.userEmail" type="email" clearable></el-input>
          </el-form-item>
          <el-form-item prop="userName">
            <el-input placeholder="请输入用户名" v-model="siginUpForm.userName" clearable></el-input>
          </el-form-item>
          <el-form-item prop="password">
            <el-input placeholder="请输入密码" v-model="siginUpForm.password" clearable type="password"></el-input>
          </el-form-item>
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="siginUp('siginUpFormRules')">注 册</el-button>
        </span>
      </el-dialog>
    </div>
  ...
  methods: {
    ...
    submitForm(formName) {
      ...
      this.$refs[formName].validate(function(valid) {
        if (valid) {
          // 校验通过提交表单;
          axios.post("/api/query/loginUp", self.loginForm).then(res => {
            console.log(res);
    ...
    siginUp(formName) {
      ...
      this.$refs[formName].validate(vaild => {
        if (vaild) {
          // 校验通过
          axios.post("/api/query/signUp", self.siginUpForm).then(res => {
